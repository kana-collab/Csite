                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-10 sm:py-30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 py-12 md:py-12 border-t border-gray-200 lg:ml-11">
                        ...
                        <div className="col-span-1 mx-auto">
                            ...
                            <li className="mb-2">
                                <a href="/privacypolicy.html" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out" target="_blank" rel="noopener noreferrer" >Privacy Policy</a>
                            </li>
                            </ul>
                        </div>
                        ...
                        {/* 4th block 
                        <div className="col-span-1 sm:col-span-12 lg:col-span-3 text-center mx-auto font-bold uppercase text-blue-900">
