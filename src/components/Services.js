        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">{data.ServiceSectionName}</h2>
                        
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-blue-900'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">{data.ServiceSectionText}</h2>
                    </div>
                                ...
                                >
                                    <div className="m-2 text-justify text-sm">
                                        <img
                                            ...
                                            src={`${DAC_URL}${service.ServiceImage?.url}` || '/default-image.jpg'} // Use a default image if CardImage is not provided
                                        />
                                        <h2 className="font-semibold my-4 text-2xl text-center">
                                            {service.CardTitle}
                                        </h2>
                                        <p className="text-md font-medium">{service.CardSubtext}</p>
                                    </div>
                                </div>
                            ))}                    
                        </div>
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">{data.Nocard[1].CardTitle}</h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    {data.Nocard[1].CardSubtext}
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">{data.Nocard[0].CardTitle}</h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>{data.Nocard[0].CardSubtext}</p>
                            </div>
                        </div>
                    </div>
                </div>
